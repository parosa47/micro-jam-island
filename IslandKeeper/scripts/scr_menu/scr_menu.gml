...
function menu_layout(_page) {
    ...
    if (_page == MENU.MAIN) {
        ...
        var _y = _gh / 2 - 110;
        array_push(_list, { id: "up",     x: _cx - 160, y: _y,       w: 320, h: 36, label: "up" });
        array_push(_list, { id: "down",   x: _cx - 160, y: _y + 44,  w: 320, h: 36, label: "down" });
        array_push(_list, { id: "left",   x: _cx - 160, y: _y + 88,  w: 320, h: 36, label: "left" });
        array_push(_list, { id: "right",  x: _cx - 160, y: _y + 132, w: 320, h: 36, label: "right" });
        array_push(_list, { id: "volume", x: _cx - 160, y: _y + 200, w: 320, h: 16, label: "volume" });
        array_push(_list, { id: "back",   x: _cx - 90,  y: _y + 232, w: 180, h: 42, label: "BACK" });
    }
    return _list;
}
